...
function fetch_data(){
    ...
    var sharehigh = []
    var sharelow = []
    const url = 'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=5min&apikey=TCMA7VL9D8UPS27D'
    ...
    .then(data => {
        ...
        document.getElementById('share_min').innerHTML = `<h3>Max: ` + min_price + `$</h3>` 
